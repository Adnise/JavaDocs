...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean remove(Object o) {
        Integer removeElement = (Integer) o;
        boolean elementExistInList = super.remove(o);
        if ((elementExistInList) && (Collections.frequency(this, removeElement) == 1))
            differentElements++;
        else ((elementExistInList) && (Collections.frequency(this, removeElement) == 0)))
            differentElements--;
